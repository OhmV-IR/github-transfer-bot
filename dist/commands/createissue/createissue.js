...
export default {
    data: new SlashCommandBuilder()
        ...
        .setRequired(true)
        .addChoices({ name: "Feature", value: "Feature" }, { name: "Task", value: "Task" }, { name: "Bug", value: "Bug" }))
        .addStringOption(opt => opt.setName("repo")
        .setDescription("The repository to make the issue on")
        .setRequired(true)
        .addChoices({ name: "Rebar", value: "pylonmc/rebar" }, { name: "Pylon", value: "pylonmc/pylon" }, { "name": "test", "value": "OhmV-IR/github-transfer-bot" }))
        .addStringOption(opt => opt.setName("labels")
        .setDescription("Labels to add to the issue separated by commas")
        .setRequired(false))
        .addBooleanOption(opt => opt.setName("close_post")
    ...
    async execute(interaction) {
        ...
        if (interaction.options.getBoolean("close_post") === true) {
